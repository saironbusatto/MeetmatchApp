...
export default function LoginPage() {
  ...
  const wrap: CSSProperties = { minHeight: "calc(100vh - 60px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: T.paper };
    ...
    <div style={wrap}>
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <p style={{ fontFamily: T.fontBody, fontSize: 14, color: T.ink500, textAlign: "center", marginTop: 20 }}>
          Não tem conta? <Link href="/signup" style={{ color: T.vermillion, fontWeight: 600 }}>Criar conta</Link>
        </p>
      </div>
    </div>
  );
